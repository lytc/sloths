...
class Generator
{
     ...
     */
    protected function setPrimaryKey($columnName)
    {
    ...
    protected function setColumns(array $columns)
    {
        foreach ($columns as $name => $type) {
            ...
            $this->classGenerator->getDocBlock()->setTag(new PropertyTag(Inflector::camelize($name), [constant('\Lazy\Db\Model\Model::' . $type)]));
     ...
     * @param array $hasMany
     */
    protected function setHasMany(array $hasMany)
    {
     ...
     * @param array $hasOne
     */
    protected function setHasOne(array $hasOne)
    {
     ...
     */
    protected function setBelongsTo(array $belongsTo)
    {
     ...
     */
    protected function setHasManyThrough(array $hasManyThrough)
    {
    ...
    {
        $filename = $this->getDirectory() . '/AbstractModel.php';
        ...
        $classGenerator->setName('AbstractModel')
            ->setNamespaceName($this->classGenerator->getNamespaceName())
            ->setExtendedClass('\Lazy\Db\Model\Model');
    ...
    public function write()
    {
        ...
        $this->classGenerator->setExtendedClass('AbstractModel');
