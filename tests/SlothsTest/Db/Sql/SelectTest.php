...
class SelectTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $select = new Select('foo');
        $this->assertInstanceOf('Sloths\Db\Sql\Where', $select->where());
        $this->assertInstanceOf('Sloths\Db\Sql\Where', $select->orWhere());
    ...
    {
        $select = new Select('foo');
        $this->assertInstanceOf('Sloths\Db\Sql\Having', $select->having());
        $this->assertInstanceOf('Sloths\Db\Sql\Having', $select->orHaving());
