...
use LazyTest\Db\Model\TestCase;
...
class HasOneTest extends TestCase
{
    public function testInstance()
    {
        ...
        $this->assertInstanceOf('LazyTest\Db\Model\Stub\Professor', $professor);
    ...
    public function testEagerLoadingAndLazyLoading()
    {
        ...
        $this->assertInstanceOf('LazyTest\Db\Model\Stub\Professor', $user1->Professor);
        $this->assertInstanceOf('LazyTest\Db\Model\Stub\Professor', $user3->Professor);
