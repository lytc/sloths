...
use LazyTest\Db\Model\Stub\FooBar;
...
class ModelTest extends TestCase
{
    ...
    public function testMethodFirst()
    {
        ...
        $user = User::first(1);
        $this->assertInstanceOf('LazyTest\Db\Model\Stub\User', $user);
    ...
    {
        $this->assertInstanceOf('LazyTest\Db\Model\Stub\User', User::create());
    }

    public function testMethodSaveShouldCallInsert()
    {
        $user = $this->getMock('LazyTest\Db\Model\Stub\User', ['insert']);
    ...
    {
        $user = $this->getMock('LazyTest\Db\Model\Stub\User', ['update'], [['id' => 1]]);
        $user->name = 'foo';
    ...
    {
        $user = $this->getMock('LazyTest\Db\Model\Stub\User', ['insert'], [['name' => 'foo']]);
        $user->expects($this->once())->method('insert');
    ...
    {
        $user = $this->getMock('LazyTest\Db\Model\Stub\User', ['update'], [['id' => 1, 'name' => 'foo']]);
    ...
    public function testToArrayAndJsonEncodeShouldNotIncludeHiddenColumn()
    {
        ...
        $this->assertSame(json_encode($expected), json_encode($user));
    }
}